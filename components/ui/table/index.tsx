...
const TableHead = React.forwardRef<View | Text, ITableHeadProps>(function TableHead(
  ...
  const styledClassName = tableHeadStyle({ class: className });
  if (useRNView) {
    return (
      <View ref={ref as React.Ref<View>} className={styledClassName} {...(props as ViewProps)} />
    );
  } else {
    return (
      <Text ref={ref as React.Ref<Text>} className={styledClassName} {...(props as TextProps)} />
    );
  }
});
...
const TableData = React.forwardRef<View | Text, ITableDataProps>(function TableData(
  ...
  const styledClassName = tableDataStyle({ class: className });
  if (useRNView) {
    return (
      <View ref={ref as React.Ref<View>} className={styledClassName} {...(props as ViewProps)} />
    );
